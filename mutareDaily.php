...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO mutare (RegNumber, DriverName, Route, Cash, Diesel, Expenses, NetCash, auditor) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_connect, $connect);
$query_mutareRecordset = "SELECT * FROM mutare";
$mutareRecordset = mysql_query($query_mutareRecordset, $connect) or die(mysql_error());
$row_mutareRecordset = mysql_fetch_assoc($mutareRecordset);
$totalRows_mutareRecordset = mysql_num_rows($mutareRecordset);
 @session_start(); ?>
...
<title>Mutare | Inter-Africa</title>
    ...
    <div class="container">
    	<div class="row">
        	<div class="col-sm-6 col-md-4 col-md-offset-4">
                ...
                <div id="header"></div>
                <div class="panel-heading">Enter The Logsheet Values</div>
                  ...
                  <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
                    ...
                    <p id="textField" class="form-group">
                      ...
                      <select name="route" class="dropDown" id="route">
                        <option value="Mutare-Harare">Mutare-Bulawayo</option>
                        <option value="Mutare-Chimoio">Mutare-Chimoio</option>
...
<?php
mysql_free_result($mutareRecordset);
?>
